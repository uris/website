...
export const introMessageMd = `# 👋 Hi! I'm Uris.

A $$Frontend dev.$$Product designer$$Maker$$Craftsman$$Coder$$Leader$$Follower$$Diver$$Motard$$ that loves making simple, intuitive products people use to$$Connect$$Be productive$$Have fun$$GSD$$Live life$$Be better$$Learn$$Be healthy$$.
